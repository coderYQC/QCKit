...
__注意：
__  1.  若调用以上扩展的这些属性，则可能会造成frame获取错误，因此不可直接调用frame来获取真实的坐标及尺寸__ 
```  
...
__注意：
__  1.  UISWitch的默认尺寸为：宽度 51，高度 31    
__  2.  若调用以上扩展的这些属性，则可能会造成frame获取错误，因此不可直接调用frame来获取真实的坐标及尺寸__
